package com.cibertec.apisama.security;
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers("/horarios/**").hasAnyAuthority("ADMINISTRADOR" , "SUPERVISOR")
                .requestMatchers("/noticias/**").hasAnyAuthority("ADMINISTRADOR" , "SUPERVISOR")
                .requestMatchers("/roles/**").hasAnyAuthority("ADMINISTRADOR" , "SUPERVISOR")
                .requestMatchers("/departamentos/**").hasAnyAuthority("ADMINISTRADOR" , "SUPERVISOR")
